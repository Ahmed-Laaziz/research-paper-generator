...
class ChatBotAnswersGenerator:
    def __init__(self):
        #model_path = "C:/Users/ADMIN/PycharmProjects/pythonProject/models/output_dir_gpt2_fineTuned_model_abstracts"
        self.tokenizer = AutoTokenizer.from_pretrained("C:/Users/ADMIN/PycharmProjects/pythonProject/models/gpt2_fineTuned_ds_chatbot_model_v20")
        model_config = GPT2Config.from_pretrained("C:/Users/ADMIN/PycharmProjects/pythonProject/models/gpt2_fineTuned_ds_chatbot_model_v20/config.json")
        self.model = AutoModelForCausalLM.from_pretrained("C:/Users/ADMIN/PycharmProjects/pythonProject/models/gpt2_fineTuned_ds_chatbot_model_v20/pytorch_model.bin", config=model_config)
